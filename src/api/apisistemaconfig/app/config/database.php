...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION', 'sistema'),
    ...
    */
    ...
    'connections' => [
        ...
        'sistema' => [
            ...
            'charset' => env('DB_CHARSET_SYSTEM', 'utf8mb4'),
            'collation' => env('DB_COLLATION_SYSTEM', 'utf8mb4_unicode_ci'),
            'prefix' => env('DB_PREFIX_SYSTEM', ''),
            'strict' => env('DB_STRICT_MODE_SYSTEM', true),
            'engine' => env('DB_ENGINE_SYSTEM'),
            'timezone' => env('DB_TIMEZONE_SYSTEM', '+00:00'),
        ],

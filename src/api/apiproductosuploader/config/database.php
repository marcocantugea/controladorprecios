...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION', 'productosuploader'),
    ...
    */
    ...
    'connections' => [
        ...
        'productosuploader' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_PUPLOADER', '127.0.0.1'),
            'port' => env('DB_PORT_PUPLOADER', 3306),
            'database' => env('DB_DATABASE_PUPLOADER', 'forge'),
            'username' => env('DB_USERNAME_PUPLOADER', 'forge'),
            'password' => env('DB_PASSWORD_PUPLOADER', ''),
            'unix_socket' => env('DB_SOCKET_PUPLOADER', ''),
            'charset' => env('DB_CHARSET_PUPLOADER', 'utf8mb4'),
            'collation' => env('DB_COLLATION_PUPLOADER', 'utf8mb4_unicode_ci'),
            'prefix' => env('DB_PREFIX_PUPLOADER', ''),
            'strict' => env('DB_STRICT_MODE_PUPLOADER', true),
            'engine' => env('DB_ENGINE_PUPLOADER'),
            'timezone' => env('DB_TIMEZONE_PUPLOADER', '-06:00'),
        ],
